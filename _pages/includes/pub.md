...
<div class='paper-box'><div class='paper-box-image'><div><img src='images\pipeline.png' alt="sym" width="100%"></div></div>
<div class='paper-box-text' markdown="1">

[Uncertainty-aware Spatiotemporal Inference of Landslide Events by Fusing Multimodal Social Media Information with Geographic Features
](https://meetingorganizer.copernicus.org/EGU26/EGU26-5757.html) \\
**Bing Xu**, Alexander Brenning

[Project]
  - Developed **an uncertainty-aware framework** for landslide event inference from social media.
  - Integrated **text, images, and geospatial data (susceptibility, rainfall)** for joint spatiotemporal modeling.
</div>
</div>
...
- **FKGRNet model**, integrates a **landslide knowledge graph with a ResNet-based deep learning network**.
- combine visual features from remote sensing images with domain knowledge for improved landslide detection.
</div>
</div>
